...
\item The eyewire paradigm broke large 3D images into small cubes, where users were asked to identify and color neurons. They got over 100,000 users.
\item this and example of the "microtask" paradigm, which gives access to a large user pool to collect data and reward participants by reputation (via gamification) or  by micro-payments (amazon turk) \cite{kittur2008crowdsourcing}.
